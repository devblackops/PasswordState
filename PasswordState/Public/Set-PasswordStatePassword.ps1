function Set-PasswordStatePassword {
    ...
    .EXAMPLE
        PS C:\> Set-PasswordStatePassword -ApiKey $key -PasswordId 1234 -GeneratePassword

        Change the password for entry 1234 to a new randomly generated one.
    .EXAMPLE
        PS C:\> Set-PasswordStatePassword -ApiKey $key -PasswordId 1234 -Username 'mypassword'
